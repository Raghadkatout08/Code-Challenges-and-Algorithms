...
class Graph:
    ...
    def add_connection(self, vertex1, vertex2):
        """
        Add a directed connection (edge) between two vertices.
    ...
    def _dfs(self, start_vertex, visited):
        """
        Perform a Depth-First Search (DFS) from the start vertex and mark visited vertices.
    ...
    def _reverse_graph(self):
        ...
        for vertex, neighbors in self.adjacency_list.items():
            for neighbor in neighbors:
                reversed_graph.add_connection(neighbor, vertex)
...
print("Graph 1 connectivity: ", end='')
print(graph1.is_fully_connected())  # Output: Not strongly connected
...
print("Graph 2 connectivity:", end='')
print(graph2.is_fully_connected())  # Output: Strongly connected